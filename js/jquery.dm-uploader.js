...
(function(factory) {
  ...
  DmUploader.prototype.checkFileCount = function(file)
  {
    if(UploadCount >= this.settings.fileCount) {
      this.settings.onFileCountExceed.call(this.element, file);
      return false;
    }else {
      return true;
    }
  ...
  DmUploader.prototype.addFiles = function(files)
  {
    ...
    for (var i= 0; i < files.length; i++)
    {
      ...
      var fileCount =  this.checkFileCount(files[i]);
  ...
  DmUploader.prototype.deleteFile = function()
  {
      if (UploadCount > 0) {
        UploadCount = UploadCount - 1;
        return true;
